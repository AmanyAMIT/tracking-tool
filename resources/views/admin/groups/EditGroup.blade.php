        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="wizard-content">
                    <form class="tab-wizard wizard-circle wizard" method="POST" action="{{route('groups.update' , $group->id)}}">	
                        {{method_field('PUT')}}
                        @csrf
                        ...
                        <section>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="submit" value="Update Group" class="btn btn-primary btn-wide mt-5">
                                </div>
                                </div>
                            </div>
