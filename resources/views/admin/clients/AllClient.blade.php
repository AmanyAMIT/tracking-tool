        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20 d-flex justify-content-between align-items-baseline">
                    ...
                    <a class="btn btn-primary btn-wide ml-3 text-white" href="{{route("clients.create")}}">Add Client</a>
                </div>
                <div class="pb-20">
                    <table class="data-table table stripe hover nowrap">
                        <thead>
                            <tr>
                                <th class="table-plus datatable-nosort">Client's Name</th>
                                <th>Email</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-plus">{{$client->email}}</td>
                                <td>
                                    <div class="dropdown">
