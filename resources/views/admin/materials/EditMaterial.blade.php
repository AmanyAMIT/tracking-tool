        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Update Material's Information</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Fill New Material's Details</h4>
                    </div>
                    <div class="wizard-content">
                        <form class="tab-wizard wizard-circle wizard" method="POST" action="{{ route('materials.update' , $material->id) }}"
                            ...
                            <input type="submit" value="Update Material" class="btn btn-primary btn-wide mt-5 ml-3">
                        </form>
                    </div>
                </div>
            </div>
